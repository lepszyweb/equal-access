---
title: "Pomoc dla reguły: Valerie_Table_DataCellRelationships"
---
...
W przypadku złożonej tabeli danych wszystkie elementy `<th>` i `<td>` muszą być powiązane za pomocą atrybutów „header” lub „scope”.
